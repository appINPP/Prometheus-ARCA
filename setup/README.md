...
The following method is intended for Linux. If you encounter any issues or use a different OS, additional information should be found on my Drive or in the Prometheus repository itself. Considering the preinstalled requirements of: 
